        ...
        <div className="row container">
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Reading, Football and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> aimshihabuddinkhan@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="Ruby" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ruby/ruby-original.svg" />
                        <h5>Ruby</h5>
                    </div>
                    <div>
                        <img alt="PostgreSql" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgreSql/postgreSql-plain-wordmark.svg" />
                        <h5>PostgreSql</h5>
                    </div>
                </div>
                <h4>
