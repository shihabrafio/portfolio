            ...
            <div className="skill-container">
              ...
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                ...
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-6'
                    defaultMessage='PostgreSQL is a powerful open-source relational database management system (RDBMS). It is commonly used to manage data and provide a reliable backend for applications.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
              ...
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                ...
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-10'
                    defaultMessage='Ruby is my preferred framework for building dynamic and elegant web applications, providing robust support for managing APIs and optimizing my HTTP execution model.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                ...
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-10'
                    defaultMessage='Rails is my go-to framework for creating web applications. It excels in simplifying the development process, offering efficient API management, and enhancing my HTTP execution model.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                ...
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-11'
                    defaultMessage='Python is a versatile and high-level programming language known for its simplicity and readability. It is widely used in web development, data analysis, artificial intelligence, and more.'
                  />
                </p>
              </div>
            </div>
